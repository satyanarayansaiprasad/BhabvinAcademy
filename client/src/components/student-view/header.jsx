...
function StudentViewCommonHeader() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 lg:px-8 h-20 flex items-center justify-between bg-white relative z-[1001]">
          <div className="flex items-center space-x-6">
            <Link to="/home" className="flex items-center group">
              ...
              <span className="font-extrabold md:text-xl text-[18px] font-serif tracking-tight text-zinc-900 lowercase">
      ...
      {/* Mobile Menu Drawer - Outside of motion.header to avoid stacking context issues */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 top-0 bg-white z-[2000] md:hidden flex flex-col pt-20"
          >
            {/* Scrollable Content Container */}
            <div className="flex-1 overflow-y-auto bg-white flex flex-col p-8 md:p-12 space-y-12">
              <nav className="flex flex-col space-y-10">
                <div className="space-y-6">
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-600 mb-2 block">Navigation</span>
              ...
              <div className="pt-12 border-t border-zinc-100 flex flex-col space-y-6">
                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-2 block">Access Area</span>
                {auth?.authenticate ? (
                  <Button
                    onClick={() => {
                      handleLogout();
                    ...
                    variant="outline"
                    className="w-full rounded-2xl h-16 font-black text-xl border-2 border-zinc-200 hover:bg-zinc-50 tracking-tight"
                  >
                    Sign Out.
                  </Button>
                ) : (
                  <Button
                    ...
                    className="w-full rounded-2xl h-16 bg-zinc-900 text-white font-black text-xl shadow-2xl shadow-zinc-900/10 active:scale-[0.98] transition-all tracking-tight"
                  >
                    Sign In.
                  </Button>
                )}
            ...
            <div className="p-8 bg-zinc-50 border-t border-zinc-100 flex items-center justify-between">
              <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest lowercase italic">bhavin.academy</span>
