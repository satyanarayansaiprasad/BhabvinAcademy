...
import { Award, CheckCircle2, Download, Share2, ShieldCheck, User } from 'lucide-react';
...
const Certificate = ({ userName, courseTitle, completionDate, instructorName, certificateId }) => {
    ...
    const handleDownload = () => {
        // In a real app, this would generate a PDF or download an image
        alert("Certificate downloading initiated... (Simulation)");
    };
