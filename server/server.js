...
const instructorCategoryRoutes = require("./routes/instructor-routes/category-routes.js");
const mediaRoutes = require("./routes/media-routes/media-routes");
...
app.use("/instructor/category", instructorCategoryRoutes);
